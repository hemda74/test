...
import styles from '../styles/DeleteSitelModel.module.css';

type Props = {};

// Delete Site Modal component
const DeleteSiteModal = (props: Props) => {
  return (
    <div
      ...
      tabIndex={-1}
      aria-labelledby="DeleteSiteModal"
      aria-hidden="true">
      <div
          ...
          <div className="modal-body p-0">
            <div className="d-flex flex-column align-items-center">
              ...
              <span className="fs-5 fw-semibold mb-5">
                ...
                <span className="myPrimary-Text" data-trans="">Cairo Site ?</span>
